...
> **最新对齐版本：** [v2.2.0](https://github.com/dataelement/bisheng/releases/tag/v2.2.0)
...
**重要提示：** 本文档为非官方开发文档，由社区贡献者整理和维护，仅供学习和参考使用。

- **官方项目仓库：** https://github.com/dataelement/bisheng
- 本文档内容可能与官方最新版本存在差异，请以官方仓库为准
- 如需获取最新、最准确的信息，请访问官方项目仓库
- 我们呼吁所有使用者尊重开源项目和贡献者的劳动成果
- 在使用本文档时，请遵守开源协议和相关法律法规
